...
public class Locadora {
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        Cliente c1 = new Cliente("Rogério Skylab");
        ...
        Cliente c2 = new Cliente("Mátilda Solanger", "matildaranger@gmail.com");
        System.out.println(c2);
        double valorLocacaoLancamento = c2.calcularLocacao(2, true);
